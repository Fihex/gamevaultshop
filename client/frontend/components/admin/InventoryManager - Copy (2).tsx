...
export const InventoryManager = () => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            // Loop through current images in state
            // If an image is in pendingFiles map, upload it now
            if (editingGame.images) {
                for (const imgUrl of editingGame.images) {
            ...
            if (result) {
                ...
                setPendingFiles(new Map()); // Clear pending
                fetchGamesManual();
            } else {
