...
export const InventoryManager = () => {
    ...
    return (
        ...
        <TopToolbar
            search={search} setSearch={setSearch} setPage={setPage} placeholder={isArchiveView ? t('inv_search_archived') : t('inv_search_active')}
                ...
                <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <div className="flex items-center gap-1 bg-vault-800 px-2 py-2.5 rounded-lg border border-vault-700 h-[42px]">
                        ...
                        <input
                            ...
                            value={minStock ?? ''}
                            onChange={e => {
                                setMinStock(e.target.value ? parseInt(e.target.value) : undefined);
                                setPage(0); // <--- ADD THIS
                            }}
                        />
                        ...
                        <input
                            ...
                            value={maxStock ?? ''}
                            onChange={e => {
                                setMaxStock(e.target.value ? parseInt(e.target.value) : undefined);
                                setPage(0); // <--- ADD THIS
                            }}
                        />
                    </div>
